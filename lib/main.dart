...
class _CarMenuScreenState extends State<CarMenuScreen> {
  List<Map<String, String>> cars = [
    ...
    },
    {
      'title': 'Легковушка',
      'image':
          'assets/AQABFIKIRoaubfEbmb1FGDAx8LGNuk1__VwP0inp0eWTRly1omM3B7Z3Mn2sJE8VW6nzFPdNM_9vgdM9qxZBbgK20mw.jpg',
  ...
  void _showCarForm({int? index}) {
    ...
    showDialog(
      ...
      builder: (context) {
        return AlertDialog(
          title:
              Text(index == null ? 'Добавить машину' : 'Редактировать машину'),
          content: Column(
